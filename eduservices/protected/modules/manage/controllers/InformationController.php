...
class InformationController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Information']))
		{
            ...
            if($model->validate()){
                if(isset($_FILES['Information']["name"]["i_pic"])&&!empty ($_FILES['Information']["name"]["i_pic"])){
                    $originfilename = $_FILES['Information']['name']['i_pic']; //文件名
                    ...
                    $tempFile = $_FILES['Information']['tmp_name']['i_pic'];
                    move_uploaded_file($tempFile,$targetFile);
                    $model->i_pic = PIC_URL.$fileName;
