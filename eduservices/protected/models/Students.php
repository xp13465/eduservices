...
class Students extends CActiveRecord
{
    ...
    */
     ...
     * @return integer $returnNum 人数Yii::app()->user->role!="4"&&
     */
    function getNum($Uarr,$smtype=1,$status=1,$pici="",$true=false){
        if(!$Uarr&&$true==false)return 0;
        $criteria=new CDbCriteria;
        $criteria->compare('s_addid', $Uarr);
