...
<head>
	...
	<script>
		KindEditor.ready(function(K) {
			...
			prettyPrint();
			var editor1 = K.create('textarea[name="testdemo"]', {
...
<body>
	...
	<form name="example" method="post" action="demo.php">
		...
		<br />
		<textarea name="testdemo" style="width:700px;height:200px;visibility:hidden;"><?php echo isset($_POST['testdemo'])?htmlspecialchars(stripslashes($_POST['testdemo'])):"" ?></textarea>
		<br />
