...
<div class="clear">
    ...
    <form action="" class="margin0" onsubmit="return checkSearch(this,'<?=Yii::app()->createUrl("admin/application/check")?>')">
	  <span>搜索：</span>
      <?php
        ...
        <table class="table table-bordered margin0 userlist userwidth">
            <thead>
                <tr>
                    ...
                    <th width="70px">序号</th>
                    <th width="75px" class='showlist'>入学批次</th>
                    <th width="110px">姓名</th>
                    <th width="205px">证件</th>
                    <th width="100px">出生地</th>
                    <th width="100px" class='showlist'>手机</th>
                    <th width="70px">层次</th>
                    <th width="130px" class='showlist'>专业</th>
                    <th width="85px">审核状态</th>
                    <th width="95px" class='showlist'>申请类型</th>
                    <th width="80px" class="showlist">申请时间<a class="order" href="<?//=$tmpURL?>"><?//=$tmp?></a></th>
