        ...
        if(Yii::app()->request->isAjaxRequest) {
            ...
            switch (true) {
                ...
                case !empty($_REQUEST['s_credentialsnumber']):
                    ...
                    $model=Students::model()->find("LOWER(s_credentialsnumber)=? and s_stype=1 and s_isdel=1 and (s_status =2 or s_status =1) {$str}",array(strtolower(trim($_REQUEST['s_credentialsnumber']))) );
                    $id=Yii::app()->user->id;
